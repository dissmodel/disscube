"""
examples/drivers/02_acre_5km.py

Derives spatial driver variables for the Acre snapped grid (AC/5km):
  - dist_cidades   → min distance to urban centers (PNLT)

Usage:
    python examples/drivers/02_acre_5km.py
"""
...
for start, end in [("2000", "2014"), ("2015", "2025")]:
    print(f"\n--- Distância a cidades ({start}-{end}) @ 5km ---")
